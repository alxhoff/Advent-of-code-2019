...
def processOutput():
    ...
    while not outp_q.empty():
        ...
        val = OUTPUT_CODE(chr(outp_q.get()))

        if val != OUTPUT_CODE.NEW_LINE:
            cur_line += val.value
        else:
